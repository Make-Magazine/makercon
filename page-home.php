...
<!--   <div class="promo-video-outer" style="display: none;">
  ...
  <div class="sponsors-home">
    <div class="row">
      <div class="col-sm-12 col-md-12">
        <h3 class="subtitle">Presenting Sponsors</h3>
    ...
    <div class="row">
      ...
      <div class="col-sm-12 col-md-6">
        <h3 class="subtitle">Participating Sponsors</h3>
    ...
    <div class="row">
      <div class="col-sm-12 col-md-4">
        <h3 class="subtitle">Communications Partner</h3>
      ...
      <div class="col-sm-12 col-md-4">
        <h3 class="subtitle">Host Sponsor</h3>
      ...
      <div class="col-sm-12 col-md-4">
        <h3 class="subtitle">Community Sponsor</h3>
  ...
  <div class="row home-panel-bot">
    ...
    <!-- Sidebar -->
    <div class="hidden-xs hidden-sm col-md-4 col-md-4">
      <div class="twitter-sidebar padbottom">
