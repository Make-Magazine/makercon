...
<article id="post-<?php the_ID(); ?>" <?php post_class('home'); ?>>
  ...
  <div class="row">
    <div class="col-md-12 home-intro">
      ...
      <p><strong>A special note of thanks to our stellar speakers for their participation.</strong></p>
    </div>
  </div>
    <div class="row">
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-6 hidden-md hidden-lg hidden-xl twitter-sidebar">
      ...
      <a class="twitter-timeline" href="https://twitter.com/search?q=%23makercon" data-widget-id="466630807038066688" height="500">Tweets about "#makercon"</a>
      <script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+"://platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>
    </div>
    <br/>
  ...
  <div class="row home-panel-top">
    ...
    <div class="col-md-6">
      <p class="lead">MakerCon connects the individuals at the forefront of the Maker Movement and taps into the best thinking on how to make things and get them to market, from new technologies to manufacturing models to funding methods. </p>
      <p class="lead">MakerCon is a meeting place for passionate entrepreneurs who want to test the commercial waters for their prototypes; cultural and civic leaders driving Maker initiatives; and product developers inspired by the Maker Movement.</p>
    </div>
  </div>
  <!-- SPONSORS -->
  ...
  <div class="row home-panel-bot">
    ...
    <div class="hidden-xs hidden-sm col-md-4 col-md-4 top15">
      <h3>Featured on FastCompany</h3>
      <div class="thumbnail">
        <a href="http://www.fastcompany.com/3045505/maker-faire-founder-dale-dougherty-on-the-past-present-and-online-future-of-the-maker-moveme" target="_blank">
        <img src="http://makercon.com/wp-content/uploads/2015/04/FastCompany-article-featured-image.jpg" alt="FastCompany article featured image" class="img-responsive" />
