...
<article id="post-<?php the_ID(); ?>" <?php post_class('home'); ?>>
    ...
    <div class="row">
      <div class="col-md-8">
        ...
        <div class="button text-center col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
          <a href="https://www.youtube.com/playlist?list=PLwhkA66li5vBEkRxCLCrX7IrHySh3LHj3">More Videos From MakerCon New York 2014</a>
        </div>
        <div class="hidden-xs hidden-sm col-md-3 col-lg-3 col-xl-3"></div>
      </div>
      <div class="col-md-4">
  ...
  <div class="row sponsors-home">
    <div class="col-md-6">
      ...
      <img class="cornell-logo" src="<?php echo get_stylesheet_directory_uri(); ?>/img/cornell_logo-02.png" alt="Cornell Logo" width="300" />
      </a>
    </div>
    <div class="col-md-6">
      ...
      <img class="autodesk-logo" src="<?php echo get_stylesheet_directory_uri(); ?>/img/fusion-autodesk-sponsor-398.png" alt="Autodesk Logo" width="300" />
      </a>
      ...
      <img class="intel-logo" src="<?php echo get_stylesheet_directory_uri(); ?>/img/intel_logo.jpg" alt="Intel Logo" width="100" />
      </a>
    </div>
  </div>
