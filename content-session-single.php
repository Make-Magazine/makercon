  ...
  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
    <div class="lead"><h2><?php the_title(); ?></h2><?php
      ...
      if(($session_video != '') && (strpos($session_video,'youtube', 0) !== false)) {
        ...
        ?>
        <div class="speaker-subtitle session-video-subtitle">
          <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/icon_video_red.png" class="video img-responsive icon-video"  data-toggle="modal" data-target="#myModal">
          <a href="#" data-toggle="modal" data-target="#myModal">Watch This Session</a>
        </div>
