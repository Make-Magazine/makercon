    ...
    <div class="lead"><h2><?php the_title(); ?></h2><?php
      ...
      if(($session_video != '') && (strpos($session_video,'youtube', 0) !== false)) {
        $session_video = str_replace(array('http:','https:','watch?v='),array('','','embed/'), $session_video);
          ?>
        <div class="speaker-subtitle session-video-subtitle"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/icon_video.png" class="video img-responsive icon-video"  data-toggle="modal" data-target="#myModal"><a href="#" data-toggle="modal" data-target="#myModal">Watch This Session</a></div>
